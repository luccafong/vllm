...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument("--multi-host-rank", type=int, default=0)
        parser.add_argument(
            "--leader-host-addr",
            type=str,
            default="localhost",
        )
        parser.add_argument("--leader-host-port", type=int, default=0)
        parser.add_argument(
            "--instance-id",
            type=str,
            default="",
    ...
    def create_engine_config(
        ...
        config = VllmConfig(
            ...
            leader_host_addr=self.leader_host_addr,
            leader_host_port=self.leader_host_port,
            multi_host_rank=self.multi_host_rank,
        )
