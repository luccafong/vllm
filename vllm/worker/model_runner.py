...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def _use_captured_graph(
        self, batch_size: int, max_decode_seq_len: int, max_encoder_seq_len: int = 0
    ) -> bool:
        return (
            self.decode_only
    ...
    def build(self) -> ModelInputForGPU:
        ...
        use_captured_graph = self._use_captured_graph(
            batch_size, max_decode_seq_len, max_encoder_seq_len=max_encoder_seq_len
        )
...
class ModelRunner(GPUModelRunnerBase[ModelInputForGPUWithSamplingMetadata]):
    ...
    def execute_model(
        ...
        with torch.profiler.record_function("model_fwd"):
        ...
        with torch.profiler.record_function("model_sample"):
