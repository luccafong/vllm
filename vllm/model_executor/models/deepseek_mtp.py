...
from .deepseek_v3 import DeepseekV3DecoderLayer, get_spec_layer_idx_from_weight_name
...
class DeepSeekMultiTokenPredictorLayer(nn.Module):
    ...
    def __init__(
        ...
        self.block = DeepseekV3DecoderLayer(
            config, prefix, cache_config, quant_config
        )
    ...
    def forward(
        ...
        # TODO: check why we need this for eagle
...
class DeepSeekMultiTokenPredictor(nn.Module):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.layers = torch.nn.ModuleDict({str(idx): DeepSeekMultiTokenPredictorLayer(
                config,
                f"{prefix}.layers.{idx}",
...
class DeepSeekMTP(nn.Module):
    ...
    def compute_logits(
        ...
        return self.model.compute_logits(hidden_states, sampling_metadata, step_idx)
