...
class LlamaModel(nn.Module):
    ...
    def forward(
        ...
        # print(f"forward start")
        if get_pp_group().is_first_rank:
            # print(f"pp first rank forward start")
            ...
            # print(f"pp non-first rank forward start")
            assert intermediate_tensors is not None
            hidden_states = intermediate_tensors["hidden_states"]
            residual = intermediate_tensors["residual"]
        # print(f"{self.start_layer=}, {self.end_layer=}")
        ...
        # print(f"pp last rank forward done, start norm")
