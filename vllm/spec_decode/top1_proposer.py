...
class Top1Proposer(SpeculativeProposer):
    ...
    def get_spec_proposals(
        ...
        if hasattr(self._worker, "model_runner") and getattr(self._worker.model_runner,"mtp", False):
            ...
            seq_group_metadata_list_for_proposal = execute_model_req.seq_group_metadata_list
        # Split speculative- and non-speculative- sequences.
        (
            proposal_lens,
            nonzero_proposal_len_seqs,
            nonzero_proposal_len_indices,
        ) = self._split_by_proposal_len(seq_group_metadata_list_for_proposal, proposal_len)
