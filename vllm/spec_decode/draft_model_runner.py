...
class TP1DraftModelRunner(ModelRunnerWrapperBase):
    ...
    def _gpu_advance_step(self, model_input: ModelRunnerInputBase,
        ...
        assert isinstance(attn_metadata, FlashAttentionMetadata) \
            or isinstance(attn_metadata, TritonMLAMetadata)
    ...
    def execute_model(
        ...
        **kwargs,
        ...
        for step in range(num_steps):
            ...
            # Compute the logits.
            logits = self.model.compute_logits(hidden_states,  # do not sample for the previous tokens
            ...
            if self.mtp:
                ...
                output = self.model.get_last_sample_output(output, attn_metadata)
